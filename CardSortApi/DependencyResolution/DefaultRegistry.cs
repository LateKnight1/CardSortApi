...
namespace CardSortApi.DependencyResolution {
    ...
    public class DefaultRegistry : Registry {
        ...
        public DefaultRegistry() {
            ...
            For<ICurrentHttpContext>().Use<CurrentHttpContext>();
            For<IAuthRepository>().Use<AuthRepository>();
            For<IHttpContextWrapperFactory>().Use<HttpContextWrapperFactory>();
